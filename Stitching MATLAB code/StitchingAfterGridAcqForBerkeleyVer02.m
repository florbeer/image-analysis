...
ParentPath = 'D:\Test0411\SaoRecon';  %Location of HF images 
OutputPath = 'D:\Test0411\GuideMap';      %Desired location of Montage image
FileName_SelectedZone = 'D:\Test0411\AcqList.txt'; %Need to generate a file of FOV list using '_AcqList.txt' file in AcqData folder
FileNameSuffix = 'Dapi'; %'Cy5_HF' or 'Dapi'
FileNameExt = 'tif';
dsf= 4;                 %downsample factor
iSizeTextMask = 512;    %Max text size: 256
iFontSize = 120;        %Max font Size: 120
iTextIntVal = 5;        %Weighting factor * Intensity of Text    %For Cy3 or Cy5, iTextIntVal = 20;     %For DAPI, iTextIntVal = 5; 
OutputFileName = 'Dapi_Test.tif'; %Final name of Montage Image
